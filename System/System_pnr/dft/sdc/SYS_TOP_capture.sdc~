...
# Created by write_sdc on Fri Oct 6 15:57:36 2023
...
set_output_delay -clock RX_CLK  20  [get_ports {SO[3]}]
set_output_delay -clock RX_CLK  20  [get_ports {SO[2]}]
set_output_delay -clock RX_CLK  20  [get_ports {SO[1]}]
set_output_delay -clock RX_CLK  20  [get_ports {SO[0]}]
